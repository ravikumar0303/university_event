...
//   const maxDisplay = 6; // Number of logos visible at a time
...
//   const handleNext = () => {
//     setStart((prevStart) =>
//       prevStart === logos.length - maxDisplay ? 0 : prevStart + 1
//     );
//   };
...
//     setStart((prevStart) =>
//       prevStart === 0 ? logos.length - maxDisplay : prevStart - 1
//     );
//   };
...
//   return (
//     <Box sx={{ display: "flex", alignItems: "center", p: 2, mt: 3 }}>
//       {/* Previous Button */}
...
//         {logos.slice(start, start + maxDisplay).map((logo, index) => (
//           <Grid item key={index}>
//             <Box
//               component="a"
//               href={logo.link}
...
//       {/* Play/Pause Button */}
//       <IconButton onClick={togglePlayPause} sx={{ ml: 2 }}>
...
//   const intervalTime = 2000; // Time interval for automatic change
//   const [isPlaying, setIsPlaying] = useState(true); // Play/Pause state
...
//         backgroundColor: "#00cc99", // Qua green color
//         p: 1,
//         borderRadius: "5px",
//         mt: 4,
//         position: "relative",
...
//           transform: `translateX(-${start * 50}px)`,
//         }}
//       >
//         {logos.slice(start, start + maxDisplay).map((logo, index) => (
//           <Grid
